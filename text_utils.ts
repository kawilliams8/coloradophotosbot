      ...
      messages: [
        {
          role: "user",
          content: `
            Compress this historical information and structure it into either two or three parts for a photo description:
            - 1. A title of roughly 15 to 20 characters. Do not include a date or any punctuation in this part.
            - 2. Optionally, the date, if given in the provided text. If a date is known, precede and follow it by a vertical bar for separation.
            ...
            Now, remove any line or paragraph breaks. We want no line break characters at all.
